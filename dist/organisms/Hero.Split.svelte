<script lang="ts">
	import BadgeTag from '../atoms/Badge.Tag.svelte';
	...
	import CaptionOverlay from '../molecules/Caption.Overlay.svelte';
	import TrustBarStats from './TrustBar.Stats.svelte';

	let {
		badgeLabel = 'ACME CORP',
		headline = 'Building',
